		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					...
					'ComboPOS requires the following plugin: %1$s.',
					'ComboPOS requires the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					/* translators: 1: plugin name(s). */
					'ComboPOS recommends the following plugin: %1$s.',
					'ComboPOS recommends the following plugins: %1$s.',
					'tgmpa'
				),
